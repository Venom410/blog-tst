      ...
      <div className="py-12 px-4 md:px-8 lg:px-16">
        <section className="mb-12">
          <p className="text-lg mb-8">
            Digicraft Technovision Private Limited (“Digicraft Technovision,” “we,” “us,” “our”) understands how important privacy is for our customers, and we endeavour to be transparent about how we gather, use, reveal, transfer, and collect your information. This Privacy Policy gives a summary of our information systems. The Privacy Policy refers to websites or online applications that apply to or link to the Privacy Policy.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg mb-8">
            ● We may obtain personal information about users when they visit our website that includes their name, address, date of birth, email address, phone numbers, information used for personalization, and other information. Digicraft Technovision uses this information to offer better service to users so we can contact them in case of any problem arises.
          </p>
          <p className="text-lg mb-8">
            ● We may request you to get personal data on other occasions, including when you utilize the services of Digicraft Technovision; when you fill surveys on Digicraft Technovision’s website; when you take participation in a blog or user forum hosted by Digicraft Technovision or any of our business companies. We may apply the information which you provide us to help you offer better services, to personalize your experience when you visit our website, and to guide you, provide purchase recommendations and for other objectives in line with this statement. We may also use this user information with third-party or parties’ data to serve our customers better.
          </p>
          <p className="text-lg mb-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4">Online Policy</h2>
          <p className="text-lg mb-8">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4">Your Consent</h2>
          <p className="text-lg mb-8">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg mb-8">
            This Privacy Policy is applicable to our website only. Digicraft Technovision may also display links to other websites over the Internet, which we assume, can be of your interest. We will not be held responsible for the content displayed on such a website, the safety of your personal information which you furnish or any data stored by that website. The risk of using such websites and web pages is solely yours.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4">Right To Information</h2>
          <p className="text-lg mb-8">
            You have the right to information regarding your personal information which we collect along with the right to blocking, rectification and deleting your saved personal information for which you are free to contact us at:- J-2846, DSIIDC, Narela Industrial Complex, Narela, Delhi, North West Delhi- 110040, India
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4">Change In Policy</h2>
          <p className="text-lg mb-8">
            Digicraft Technovision holds the right to revise this Privacy Policy without giving prior notification to show legal, regulatory changes, technological advancements and business practices. If we revise our privacy methods, a new Privacy Policy will display those developments and the effective date of the updated Privacy Policy will be set out at the starting of the new or revised Privacy Policy.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-lg mb-8">
            For any queries related to our privacy policy or the usage of your personal data or information, you can write us through email at <Link href="mailto:hi@digicraft.ai" className="text-blue-500 underline">hi@digicraft.ai</Link>.
          </p>
        </section>
      </div>
    </div>
